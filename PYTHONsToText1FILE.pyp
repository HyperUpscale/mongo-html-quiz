...
def combine_py_files(directory):
    # Open a new text file for writing the combined content
    with open('all_PYs_combined.txt', 'w', encoding='utf-8') as combined_file:
    ...
    print("Combined text file from PY files created successfully!")
